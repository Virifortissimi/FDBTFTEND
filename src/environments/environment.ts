type RuntimeConfig = {
    ...
    authEncryptionFallback?: {
        keyId?: string;
        algorithm?: string;
        publicKeySpkiBase64?: string;
        expiresAtUtc?: string;
    };
    authSigningPublicKeySpkiBase64?: string;
};
...
export const environment = {
    ...
    apiUrl: runtimeConfig.apiUrl || 'http://localhost:8092/api/v1',
    aiCoach: {
    ...
    authEncryptionFallback: runtimeConfig.authEncryptionFallback,
    authSigningPublicKeySpkiBase64: runtimeConfig.authSigningPublicKeySpkiBase64
};

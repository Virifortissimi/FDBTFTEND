...
export class AppComponent implements AfterViewInit {
  title = 'FoodbotUI';
  private aos: typeof import('aos').default | null = null;
  ...
  private refreshAos(): void {
    if (!isPlatformBrowser(this.platformId) || !this.aos) {
      return;
    }

    window.setTimeout(() => this.aos?.refreshHard(), 80);
  }
}

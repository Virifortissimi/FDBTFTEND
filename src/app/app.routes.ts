...
export const routes: Routes = [
    ...
    { path: 'privacy-policy', loadComponent: () => import('./features/corporate/pages/legal-page/legal-page.component').then(m => m.LegalPageComponent) },
    { path: 'terms-of-service', loadComponent: () => import('./features/corporate/pages/legal-page/legal-page.component').then(m => m.LegalPageComponent) },

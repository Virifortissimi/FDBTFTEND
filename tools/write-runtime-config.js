...
const runtimeConfig = compact({
  ...
  authEncryptionFallback: compact({
    keyId: env.FOODBOT_AUTH_FALLBACK_KEY_ID,
    algorithm: env.FOODBOT_AUTH_FALLBACK_ALGORITHM,
    publicKeySpkiBase64: env.FOODBOT_AUTH_FALLBACK_PUBLIC_KEY_SPKI_BASE64,
    expiresAtUtc: env.FOODBOT_AUTH_FALLBACK_EXPIRES_AT_UTC,
  }),
  authSigningPublicKeySpkiBase64: env.FOODBOT_AUTH_SIGNING_PUBLIC_KEY_SPKI_BASE64,
});
